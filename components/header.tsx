...
export default function Header() {
  ...
  return (
    <header className='z-[999] relative'>
        ...
        round-none border border-white border-opacity-40 bg-white bg-opacity-80
        ...
        sm:h-[initial] sm:py-0">
            ...
            text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flax-nowrap sm:gao-5'>
                {links.map(link   =>(
                    <motion.li 
                    className='h-3/4 flex item-center justify-center relative'
                     ...
                     >
                        <Link 
                          className={clsx("flex w-full  items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-grey-500 dark:hover:text-gray-300", 
                          {
